                            ...
                            <tbody>
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->Ten }}</td>
                                        <td>{{ $item->KyLamViec }}</td>
                                        <td>{{ $item->TongLuong }}</td>
                                        <td>{{ $item->DaTra }}</td>
                                        <td>{{ $item->ConCanTra }}</td>

                                        <td>
                                            @hasRole(['Admin', 'Edit'])
                                                <a class="btn btn-sm btn-primary"
                                                    href="{{ route('admin.updatebangluong.form', ['MaBangLuong' => $item->MaBangLuong]) }}">Edit</a><br>
                                            @endhasRole

                                            @hasRole(['Admin', 'Delete'])
                                                <a class="btn btn-sm btn-danger mt-1"
                                                    href="{{ route('admin.deletebangluong', ['MaBangLuong' => $item->MaBangLuong]) }}">Delete</a>
                                            @endhasRole
                                        </td>
